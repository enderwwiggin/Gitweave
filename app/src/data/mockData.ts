...
export const projects: Project[] = [
  ...
  {
    id: 'p3', name: '机械臂', description: 'REBOT/Piper训练、采集推理复现',
    status: 'active', lead: teamMembers[6], members: [teamMembers[6], teamMembers[9]],
    startDate: '2026-06-01',
  },
  {
    id: 'p4', name: 'Ego 系列', description: 'EGO交付、SLAM/深度算法优化',
    status: 'active', lead: teamMembers[2], members: [teamMembers[2], teamMembers[6], teamMembers[8], teamMembers[5]],
    startDate: '2026-06-01',
  },
  {
    id: 'p5', name: '机器人', description: 'AlohaMini机器人研究、语音交互、双臂协作',
    status: 'active', lead: teamMembers[8], members: [teamMembers[2], teamMembers[4], teamMembers[5], teamMembers[6], teamMembers[8], teamMembers[9]],
    startDate: '2026-06-01',
  },
  {
    id: 'p6', name: '其他', description: '产品交付、文档、品牌宣传',
    status: 'active', lead: teamMembers[7], members: [teamMembers[2], teamMembers[7], teamMembers[10]],
    startDate: '2026-06-01',
  },
];
...
export const tasks: Task[] = [
  {
    id: 'wk1', projectId: 'p6', title: '所有产品交付',
  ...
  {
    id: 'wk2', projectId: 'p1', title: '便捷的umi夹爪能否发送数据给机械臂',
    description: '', assignee: teamMembers[2], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk3', projectId: 'p1', title: 'rebot机械臂能否用umi遥操',
    description: '', assignee: teamMembers[2], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk4', projectId: 'p5', title: 'pi模型推理微调',
    description: '', assignee: teamMembers[2], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk5', projectId: 'p5', title: '双臂协作推理',
    description: '', assignee: teamMembers[2], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk6', projectId: 'p2', title: '触觉手套和软件定型',
  ...
  {
    id: 'wk7', projectId: 'p2', title: '夹爪触觉方案研究',
    description: '', assignee: teamMembers[3], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk8', projectId: 'p4', title: 'ego管线建立',
  ...
  {
    id: 'wk9', projectId: 'p5', title: 'pi模型推理微调',
    description: '', assignee: teamMembers[4], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk10', projectId: 'p3', title: 'rebot机械臂',
    description: '', assignee: teamMembers[4], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk11', projectId: 'p4', title: 'ego遥操作尝试',
    description: '', assignee: teamMembers[4], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk12', projectId: 'p5', title: '双臂协作推理',
    description: '', assignee: teamMembers[4], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk13', projectId: 'p4', title: '新的双目模组搭建',
  ...
  {
    id: 'wk14', projectId: 'p5', title: '亚博x5测试',
    description: '', assignee: teamMembers[5], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk15', projectId: 'p4', title: '寻找更合适的ego方案不丢帧的自己能组摄像头和板子',
    description: '', assignee: teamMembers[5], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk16', projectId: 'p6', title: '课程设计实训课资料整理修改',
  ...
  {
    id: 'wk17', projectId: 'p6', title: '所有产品外观确定',
    description: '', assignee: teamMembers[6], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk18', projectId: 'p4', title: 'ego设备slam算法和深度算法精度评估',
    description: '', assignee: teamMembers[6], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk19', projectId: 'p4', title: '和武一起找更好的ego设备方案',
    description: '', assignee: teamMembers[6], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk20', projectId: 'p2', title: 'imu比较选型看是否需要更换',
    description: '', assignee: teamMembers[6], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk21', projectId: 'p5', title: 'alohamini机器人研究以及先做语音交互模型训练',
  ...
  {
    id: 'wk22', projectId: 'p6', title: '所有产品的品牌参数手册完成',
  ...
  {
    id: 'wk23', projectId: 'p6', title: '用户文档完成',
    description: '', assignee: teamMembers[7], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk24', projectId: 'p6', title: '质量评估完成',
    description: '', assignee: teamMembers[7], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk25', projectId: 'p6', title: '代码管理完成',
    description: '', assignee: teamMembers[7], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk26', projectId: 'p6', title: '产品交付外观质检和测试',
    description: '', assignee: teamMembers[7], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk27', projectId: 'p6', title: '宣传片制作及广告推广',
    description: '', assignee: teamMembers[7], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk28', projectId: 'p4', title: 'ego采集视频数据处理管线搭建',
  ...
  {
    id: 'wk29', projectId: 'p5', title: 'pi0.7模型能否在pi0.5基础上调整',
    description: '', assignee: teamMembers[8], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk30', projectId: 'p4', title: 'ego遥操作及灵巧手训练探索',
    description: '', assignee: teamMembers[8], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk31', projectId: 'p5', title: '采集和推理在各机械臂复现pi0.5模型推理',
  ...
  {
    id: 'wk32', projectId: 'p2', title: 'semg的imu选型和结合',
    description: '', assignee: teamMembers[9], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk33', projectId: 'p3', title: '堆木头机械臂对齐训练',
    description: '', assignee: teamMembers[9], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
  ...
  {
    id: 'wk34', projectId: 'p6', title: '所有新设备画板子（润峰安排）',
  ...
  {
    id: 'wk35', projectId: 'p6', title: '新设备外形调整（润峰安排）',
    description: '', assignee: teamMembers[10], editors: [], viewers: [],
    tags: [], status: 'todo', priority: 'P1', branch: 'weekly',
    createdAt: '2026-07-06', updatedAt: '2026-07-06',
    transferHistory: [],
